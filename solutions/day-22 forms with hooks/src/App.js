...
const App = (props) => {
  ...
  const onChange = (e) => {
    ...
    */
    ...
    /*
    [variablename] we can make a value stored in a certain variable 
    could be a key for an object, in this case a key for state
    */
  ...
  const onSubmit = (e) => {
    ...
    */
    ...
    // backend API here, data to database
    console.log(data);
  };
  ...
  //accessing state value by destructuring state
  const {
    firstName,
    lastName,
    title,
...
/*const App = (props) => {
  ...
  const onSubmit = (e) => {
      ...
      e.preventDefault()
        stops the default behavior of form element, specifically refreshing page
    
    e.preventDefault();

    
      here is place where we connect backend api
